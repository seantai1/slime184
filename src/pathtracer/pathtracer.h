...
namespace CGL {
    ...
    public:
        ...
        // Random-walk subsurface scattering inside a bounded HomogeneousMedium.
        // The ray `r` is assumed to have already entered the medium (refracted in).
        Vector3D random_walk_radiance(Ray r,
                                      const class HomogeneousMedium* medium,
                                      int walk_depth);
