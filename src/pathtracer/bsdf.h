...
class BSDF {
 public:
  ...
  // Optional homogeneous medium inside this surface (for SSS).
  // Null by default; glass-like materials may set this via the scene parser.
  HomogeneousMedium* medium_inside = nullptr;
